...
**Example Usage:**
```lua
string = h2m.path.get_parent(path)
```
...
**Example Usage:**
```lua
string table = h2m.path.get_directories(root_path)
```
...
**Example Usage:**
```lua
string table = h2m.path.get_files(root_path)
```
...
**Example Usage:**
```lua
boolean = h2m.path.create_directory(path)
```
